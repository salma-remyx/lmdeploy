...
- \[2026/08\] Reduced Matrix Multiplication (RMM): opt-in, training-free reduction of the qkv/mlp matrix products via `LMDEPLOY_RMM_ENABLE=1` and `LMDEPLOY_RMM_KEEP_RATIO` — adapted from [arXiv:2608.13426](https://arxiv.org/abs/2608.13426v1)
